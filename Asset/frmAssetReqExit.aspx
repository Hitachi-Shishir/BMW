<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="frmAssetReqExit.aspx.cs" Inherits="frmAssetReqExit" %>
        ...
        <div class="container-fluid mt-3">
            ...
            <div class="card mb-1">
                ...
                <div class="card-tittle row">
                    <div class="col-8">
                        <asp:Label ID="lblsofname" runat="server" Text="Asset Deallocation Request" CssClass="h6 mb-0"></asp:Label>
                    </div>
                ...
                <div class="card-body">
                    <div class="row g-2">
                        ...
                        <div class="col-md-3">
                            ...
                            <asp:TextBox ID="txtEmpName" runat="server" class="form-control form-control-sm" Enabled="false" autocomplete="off"></asp:TextBox>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <asp:TextBox ID="txtemail" runat="server" class="form-control form-control-sm" Enabled="false" autocomplete="off"></asp:TextBox>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <asp:TextBox ID="txtApprover" runat="server" class="form-control form-control-sm" autocomplete="off"></asp:TextBox>
                        </div>
                        ...
                        <div class="col-md-3 ">
                            <label class="form-label ">Resign Received Date </label>
                            <asp:TextBox ID="txtResignReceived" runat="server" class="form-control form-control-sm" ClientIDMode="static">1900-01-01</asp:TextBox>
                        </div>

                        <div class="col-md-3 ">
                            <label class="form-label ">Last Working Date </label>
                            <asp:TextBox ID="txtLastWorking" runat="server" class="form-control form-control-sm" ClientIDMode="static">1900-01-01</asp:TextBox>
                        </div>
                        <div class="col-md-3" hidden>
                            <label class="form-label ">
                                Asset Type
                        ...
                        <div class="col-md-3" hidden>
                            ...
                            <asp:DropDownList ID="ddlCategory" runat="server" CssClass="form-control form-control-sm chzn-select" OnSelectedIndexChanged="ddlCategory_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
                        </div>
                        ...
                        <div class="col-md-3 " hidden>
                            ...
                            <asp:DropDownList ID="ddlRequestType" runat="server" class="form-control form-control-sm chzn-select">
                                <asp:ListItem Value="New">New</asp:ListItem>
                                <asp:ListItem Value="Repair">Repair</asp:ListItem>
                                <asp:ListItem Value="Replacement">Replacement of EOL</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                        <div class="col-md-3" hidden>
                            <label class="form-label ">
                        ...
                        <div class="col-md-12 text-end">
                            ...
                            <asp:Label ID="lblApprover" runat="server" ForeColor="red"></asp:Label>
                            ...
                            <asp:Button ID="btnRequest" runat="server" Text="Submit" class="btn btn-sm  btn-primary
      "
                                OnClick="btnRequest_Click" ValidationGroup="save" />
                        </div>
                    </div>
...
" OnRowDataBound="gvHRRequest_RowDataBound">
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="Resign Received Date" DataField="ResignReceivedDate" DataFormatString="{0:yyyy-MM-dd}" />
                                            <asp:BoundField HeaderText="Last Working Date" DataField="LastWorkingDate" DataFormatString="{0:yyyy-MM-dd}" />
                                            <asp:BoundField HeaderText="Department" DataField="Department" />
                                            <asp:BoundField HeaderText="Location" DataField="Location" />
                                            <asp:BoundField HeaderText="Approver Email" DataField="FApproverEmail" />
