...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
                                ...
                                <div class="row gx-2 gy-2">
                                    ...
                                    <div class="col-md-6">
                                        <label for="staticEmail" class="form-label">
                                            Employee ID 
                                            <asp:RequiredFieldValidator ID="rfvtxtLoginName" InitialValue="0"  runat="server" ControlToValidate="ddloginName" ErrorMessage="*" ForeColor="Red" ValidationGroup="SearchUser"></asp:RequiredFieldValidator>
                                        </label>
                                        <div class="input-group input-group-sm ">
                                     <asp:DropDownList  ID="ddloginName" runat="server" AutopostBack="true" class="form-select form-select-sm single-select-optgroup-field" autocomplete="off" ValidationGroup="SearchUser" OnSelectedIndexChanged="ddloginName_SelectedIndexChanged" ></asp:DropDownList>

                                            <asp:LinkButton hidden ID="btnSearch" runat="server" OnClick="btnSearch_Click" ValidationGroup="SearchUser" CssClass="btn btn-sm btn-secondary"><i class="fa-solid fa-search"></i></asp:LinkButton>
                                        </div>
                  ...
                  <asp:RequiredFieldValidator ID="rfvddlDepartment" runat="server" ControlToValidate="ddlDepartment" ErrorMessage="*" ForeColor="Red" InitialValue="0" ValidationGroup="Addticket"></asp:RequiredFieldValidator>
                                    ...
                                    <div class="col-md-6">
                                        <asp:Panel ID="pnlSRFields" runat="server" Visible="false">
                                            <div class=" row   ">
                                                <div class="col-md-12">
                                                    <label for="staticEmail" class="form-label">
                                                        <asp:Label ID="Label13" Text="IT Approver " runat="server"></asp:Label>
                                ...
                                <div class="row gx-2 gy-3 mt-1">
                                    <div class="col-6">
                                        <div class="row gx-3 gy-2">
                                            ...
                                            <div class="col-md-12">
                                                <asp:GridView ID="grd" runat="server" CssClass="data-table1 table-striped table-sm table table-head-fixed text-nowrap border " AutoGenerateColumns="false">
                                                    <Columns>
                            ...
                            <div class="card-body">
                                <div class="row gy-3 gx-2">
                                    <div class="col-md-12">
                                        <asp:GridView ID="gvAssets" DataKeyNames="SerialNo" runat="server" CssClass="data-table1 table-striped table-sm table table-head-fixed text-nowrap border " AutoGenerateColumns="False" OnRowDataBound="gvAssets_RowDataBound">
                                            <Columns>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="input-group input-group-sm">
                                                        <asp:TextBox ID="txtDownTimeStart" runat="server" CssClass="form-control form-control-sm datepicker flatpickr-input" MaxLength="10" autocomplete="off" ClientIDMode="static"></asp:TextBox>
          ...
          <EmptyDataRowStyle HorizontalAlign="Center" BorderStyle="None" Height="5px" BorderColor="#EDEDED" BackColor="#EDEDED" />--%>
                    ...
                    <div class="row">
                        <div class="col-md-12 text-end">
                            ...
                            <asp:Button ID="btnSubmit" runat="server" AutoPostBack="true" Text="Submit" ValidationGroup="Addticket" OnClick="btnSubmit_Click" OnClientClick="return validateSelection();" CssClass="btn btn-sm btn-grd btn-grd-info " />
 ...
 <asp:PostBackTrigger ControlID="ddloginName" />
    ...
    <script type="text/javascript">
        // Allow only numeric input (0-9) for the phone number field
        function isNumberKey(event) {
            var charCode = (event.which) ? event.which : event.keyCode;
            // Check if the character is not a number
            if (charCode < 48 || charCode > 57) {
                // If not a number, prevent the character from being entered
                return false;
            }
            return true;
        }
    ...
    function validateSelection() {
        var requestType = document.getElementById('<%= hfRequestType.ClientID %>').value;

        // Skip validation for "Service Request"
        if (requestType === "Service Request") {
            return true;
        }

        var gridView = document.getElementById('<%= gvAssets.ClientID %>');
        if (!gridView) return true;
