                        ...
                        <div class="card-body position-relative p-4">
                            <div class="row g-2">
                                <div class="d-flex  gap-3 mb-4 align-content-between">
                                 ...
                                 <div class="col-md-8 text-end">
                                        <p class="menu-title small">(Default data from the last 7 days since today)
 </p>
                                   </div>
                                </div>
                            </div>
                            <div class="row mb-5 gx-3 gy-1">
                                ...
                                <div class="col-md-2 col-5">
                                    ...
                                    <asp:TextBox AutoCompleteType="None" runat="server" Placeholder="" ID="txtfrmDate" class="form-control form-control-sm datepicker"></asp:TextBox>
                                </div>
                                <div class="col-md-2 col-5">
                                    ...
                                    <asp:TextBox AutoCompleteType="None"  runat="server" Placeholder="" ID="txttoDate" class="form-control form-control-sm datepicker"></asp:TextBox>
                                </div>
