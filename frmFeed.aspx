<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmFeed.aspx.cs" Inherits="frmFeed" ValidateRequest="false" %>
    ...
    <form id="form1" runat="server">
        <div class="col-md-6 m-auto mt-4">
            <div class="card shadow">
                        ...
                        <div class="card border rounded " style="height: 70vh">
                            <div class="card-body">
                                <asp:Panel ID="Panel1" runat="server">
                                    ...
                                    <div class="row g-3 ">
                                        <div class="col-md-12">
                                            <asp:Label ID="Label2" runat="server" Text="0" Visible="false" CssClass="form-label"></asp:Label>
                                            <asp:Label ID="Label3" runat="server" Text="Ticket Id" CssClass="form-label"></asp:Label>
                                            <br />
                                            <asp:TextBox ID="txtEmpID" runat="server" CssClass="form-control form-control-sm" ReadOnly="True">0</asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredEMPCOE" runat="server" ControlToValidate="txtEmpID" ErrorMessage="Required" ForeColor="Red" ValidationGroup="Bla"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="col-md-12 mt-0">
                                            <asp:Repeater ID="RepeaterforShowSurveyQuestion" runat="server" OnItemDataBound="RepeaterforShowSurveyQuestion_ItemDataBound">
                                                <ItemTemplate>
                                                    <div style="width: 100%">
                                                        <asp:Label ID="Label2" Text='<%#(((RepeaterItem)Container).ItemIndex+1).ToString()%>' runat="server" CssClass="questiontext" />
                                                        <asp:Label ID="q" runat="server" Text='<%# Eval("Question") %>' CssClass="questiontext"></asp:Label>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                                            ErrorMessage="*" ForeColor="Red" ControlToValidate="dtlAnswers" ValidationGroup="Bla"></asp:RequiredFieldValidator>
                                                        <asp:HiddenField ID="hnQuestionsid" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "QuestionId")%>' />
                                                    </div>
                                                    <asp:RadioButtonList ID="dtlAnswers" runat="server" ValidationGroup="Bla" RepeatDirection="Horizontal" RepeatColumns="20" CssClass="rep">
                                                    </asp:RadioButtonList>
                                                </ItemTemplate>
                                            </asp:Repeater>
                                        </div>
                                        <div class="col-md-12">
                                            <asp:Label class="form-label " ID="Label8" runat="server" Text="Do you have any suggestion to improve our service?"></asp:Label>
                                    ...
                                    <div style="background: #F0F0F0; display: none; border-top: 2px solid #ccc; color: #000000; width: auto">
                ...
                <%-- Thankyou card --%>
                <div class="card-body " id="thankyouCard" style="display: none">
                    <div class="card rounded border bg-white mb-0">
                        <div class="card-body bg-white rounded">
                            <div class="row mt-3">
                                ...
                                <div class="col-md-12 text-center mt-4">
                                    <h6 class="text-success  opacity-75 mb-3">"Your feedback has been received – we’re on it!"</h6>
                                </div>
                            </div>
                        </div>
                    </div>
