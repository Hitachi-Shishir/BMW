<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="frmMergeNGroupUpdt.aspx.cs" Inherits="frmMergeNGroupUpdt" %>
			...
			<div class="col-md-6 col-lg-12 col-sm-4">
				<div class="card card-default">
					...
					<div class="card-body">
						...
						<div class="row">
							<div class="col-md-6 col-lg-12 col-sm-4">
								<label class="cardheader">Bulk Update Ticket</label>
					...
					<label for="staticEmail" class="col-sm-2 labelcolorl1 pl-4">
							...
							<div class="form-group row ">
												<label for="exampleInputBorder" class="col-sm-2 labelcolorl1 pl-4">
													Resolution : 
												</label>
